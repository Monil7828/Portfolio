...
export const Timeline = ({ data }) => {
  ...
  return (
     <section id="work">
    <div className="pt-20 w-full" ref={containerRef}>
      {/* Full-width header */}
      ...
      {/* Timeline content with max-width container */}
      <div className="mx-auto w-full ">
        <div className="flex w-full">
          <div ref={ref} className="relative flex-1 pr-7 pb-20">
            {/* Timeline Line */}
            <div className="absolute md:right-8.5 right-6 -top-10 h-full w-1 bg-neutral-800 rounded-full overflow-hidden z-10">
              <motion.div
                style={{
              ...
              >
                <div className="flex flex-row-reverse">
                  ...
                  <div className="relative z-10 w-16 shrink-0">
                    <div className="sticky pl-12 top-1/2 h-0 flex items-center justify-center">
                      <motion.div
                  ...
                  {/* Timeline Card */}
                  <motion.div
                    className={`mr-4 md:mr-8 ml-8 p-8 rounded-2xl backdrop-blur-sm transition-all duration-300 ${
                      activeIndex === index
